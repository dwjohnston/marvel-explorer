...
import {
  MarvelCharacter,
  MarvelResource,
  MarvelResourceCollection,
} from "../../types/MarvelCharacter";
...
export const SelectedCharacterPanel = (props: SelectedCharacterPanelProps) => {
  ...
  const thumbnail = selectedCharacter
    ? getLargestImage(selectedCharacter.thumbnail)
    : null;

  return (
    <StyledSelectedCharacterPanel
      className={`dj-marvel-selected-character-panel ${className}`}
    >
      {selectedCharacter && (
        <>
